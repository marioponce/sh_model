...
SECRET_KEY = 'md_avhyj^mv_hlpfl0@zbgf$@r)f-*1e!+=!#^gm)ai52wb=+@'
...
WSGI_APPLICATION = 'shm_prj.wsgi.application'
...
if 'RDS_DB_NAME' in os.environ:
    ...
    DATABASES = { 
        'default': {
            ...
            'USER': 'superuser',
            'PASSWORD': 'Delft2022',
            'HOST': 'awseb-e-pqs3kbar3w-stack-awsebrdsdatabase-zfiztkoajpmc.cwfex9drokvc.us-west-2.rds.amazonaws.com',
            'PORT': '5432',
        }
    }
